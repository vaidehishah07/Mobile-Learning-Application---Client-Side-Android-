...
public class MLAListData {
    ...
    public HashMap<String,List<MLAListModel>> getlist()  {
        ...
        if(userType.equals("admin"))
        {
            ...
            Posts.add(new MLAListModel("Timeline"));
            Posts.add(new MLAListModel("List of Friends"));
            Posts.add(new MLAListModel("Add Friend"));
            Posts.add(new MLAListModel("Friend Requests"));
            Posts.add(new MLAListModel("Add Groups"));
            Posts.add(new MLAListModel("Delete Groups"));
            //Posts.add(new MLAListModel("Update Groups"));
            ...
            navDrawerHashMap.put("Social Media",Posts);
