...
import com.paril.mlaclientapp.ui.fragment.MLAAcceptRejectRequestFragment;
import com.paril.mlaclientapp.ui.fragment.MLAAddFriendsToGroupFragment;
import com.paril.mlaclientapp.ui.fragment.MLAFriendsFragment;
...
import com.paril.mlaclientapp.ui.fragment.DeleteGroupFragment;
...
import com.paril.mlaclientapp.ui.fragment.MLAPostFragment;
import com.paril.mlaclientapp.ui.fragment.ShowListOfFriendsFragment;
            ...
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int groupPosition, long l) {
                if (expandableListView.getExpandableListAdapter().getChildrenCount(groupPosition) == 0) {
                    if (lastGroupSelPos != groupPosition) {
                        ...
                        else if (listPrimary.get(groupPosition).equals("Social Media"))
                        {
        ...
        listExpandable.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                if (lastGroupSelPos != groupPosition || lastChildSelPos != childPosition) {
                    ...
                    else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Add Friend") && listPrimary.get(groupPosition).equals("Social Media")) {
                        setToolbarTitle("Add Friend");
                        MLAFriendsFragment mlaFriendsFragment = new MLAFriendsFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlaFriendsFragment);
                        fragmentTransaction.commit();
                    }

                    else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Timeline") && listPrimary.get(groupPosition).equals("Social Media")) {
                        setToolbarTitle("Timeline");
                        MLAPostFragment mlaPostFragment = new MLAPostFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlaPostFragment);
                    ...
                    else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Friend Requests") && listPrimary.get(groupPosition).equals("Social Media")) {
                        setToolbarTitle("Friend Requests");
                        MLAAcceptRejectRequestFragment mlaAcceptRejectRequestFragment = new MLAAcceptRejectRequestFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlaAcceptRejectRequestFragment);
                        fragmentTransaction.commit();
                    }

                    else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Add Groups") && listPrimary.get(groupPosition).equals("Social Media")) {
                        setToolbarTitle("Add Groups");
                        MLAAddFriendsToGroupFragment mlaCreateGroup = new MLAAddFriendsToGroupFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlaCreateGroup);
                        fragmentTransaction.commit();
                   }

                   //
                   else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("List of Friends") && listPrimary.get(groupPosition).equals("Social Media")) {
                        setToolbarTitle("List of Friends");
                        ShowListOfFriendsFragment mlaListFriends = new ShowListOfFriendsFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlaListFriends);
                        fragmentTransaction.commit();
                    }

                    else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Delete Groups") && listPrimary.get(groupPosition).equals("Social Media")) {
                        setToolbarTitle("Delete Groups");
                        DeleteGroupFragment deleteGroupFragment = new DeleteGroupFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, deleteGroupFragment);
                        fragmentTransaction.commit();
                    }
                    /*else if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Update Groups") && listPrimary.get(groupPosition).equals("Social Media")) {
                        setToolbarTitle("Update Groups");
                        MLAUpdateGroupFragment mlaUpdateGroupFragment = new MLAUpdateGroupFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, mlaUpdateGroupFragment);
                        fragmentTransaction.commit();
                    }
*/
